  ...
  describe("argsToCommandLine", () => {
    ...
    describe("Real-world cases", () => {
      it("quotes within quotes", () => {
        check(
          "cmd.exe",
          ["/c", "powershell -noexit -command 'Set-location \"C:\\user\"'"],
          'cmd.exe /c "powershell -noexit -command \'Set-location \\"C:\\user\\"\'"',
        );
      });
      it("space within quotes", () => {
        check(
          "cmd.exe",
          ["/k", '"C:\\Users\\alros\\Desktop\\test script.bat"'],
          'cmd.exe /k \\"C:\\Users\\alros\\Desktop\\test script.bat\\"',
        );
      });
    });
  });
