...
function pollForProcessState(desiredState: IProcessState, intervalMs = 100, timeoutMs = 2000): Promise<void> {
...
function pollForProcessTreeSize(
  pid: number,
  size: number,
  intervalMs = 100,
  timeoutMs = 2000,
): Promise<IWindowsProcessTreeResult[]> {
