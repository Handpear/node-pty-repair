...
import type { IProcessEnv, IPtyForkOptions, IPtyOpenOptions } from "./interfaces";
import { DEFAULT_COLS, DEFAULT_ROWS, Terminal } from "./terminal";
import type { ArgvOrCommandLine } from "./types";
...
export class UnixTerminal extends Terminal {
  ...
  private _boundClose = false;
  private _emittedClose = false;
  private _master: net.Socket | undefined;
  private _slave: net.Socket | undefined;

  public get master(): net.Socket | undefined {
    return this._master;
  }
  public get slave(): net.Socket | undefined {
    return this._slave;
  }

  public constructor(file?: string, args?: ArgvOrCommandLine, opt?: IPtyForkOptions) {
    super(opt);
  ...
  public static open(opt: IPtyOpenOptions): UnixTerminal {
    ...
    self._master = new PipeSocket(term.master as number);
    if (encoding !== null) {
...
class PipeSocket extends net.Socket {
  public constructor(fd: number) {
    const pipeWrap = (process as any).binding("pipe_wrap"); // tslint:disable-line
